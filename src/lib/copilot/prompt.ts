...
export const SYSTEM_PROMPT = [
  ...
  "6. Her barin slot sayisi o barin KENDI grid'iyle tam uyumlu olmali.",
  "   Ayni bolumdeki barlar farkli grid'de olabilir; her bar icin verilen",
  "   slot sayisini kullan, bir onceki barinkini degil.",
  "7. Barin grid'ini degistiremezsin. Grid bar sekillerinde yazilidir ve",
  "   sabittir; farkli bir slot sayisi gonderirsen patch reddedilir.",
  "8. Grid degerleri: 1/8, 1/8 ucleme, 1/16, 1/16 ucleme, 1/32.",
  "   Ucleme grid'lerde bir vurus 3 slottur, 2 veya 4 degil; 1/8 ucleme",
  "   4/4 barda 12 slot, 1/16 ucleme 24 slot demektir.",
  "9. Yeni track olusturma.",
  "10. Nota basina en fazla BIR articulation yaz; birlestirme yok.",
  "",
